...
import com.dhl.base.databinding.DialogCommonStyle2Binding

open class CommonDialogStyle2(context: Context) : BaseDialog(context, R.style.Base_Dialog_Common) {

    protected var binding: DialogCommonStyle2Binding = DialogCommonStyle2Binding.inflate(layoutInflater)
    ...
    companion object {
        ...
        fun showTipsDialog(
            ...
            return CommonDialogStyle2(context).apply {
