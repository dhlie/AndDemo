...
public class TitleBar extends FrameLayout {
	...
	private void addRightButton(Drawable fDrawable, String fText, Drawable sDrawable, String sText, Drawable tDrawable, String tText) {
		...
		if (btnCount == 0) {
			...
			if (thirdView != null)
				linearLayout.addView(thirdView, new LinearLayout.LayoutParams(tvWidth, mTitleBarHeight));
			if (secondView != null)
				linearLayout.addView(secondView, new LinearLayout.LayoutParams(svWidth, mTitleBarHeight));
			if (firstView != null)
				linearLayout.addView(firstView, new LinearLayout.LayoutParams(fvWidth, mTitleBarHeight));
			LayoutParams params = new LayoutParams(LayoutParams.WRAP_CONTENT, mTitleBarHeight);
			params.gravity = Gravity.RIGHT;
